...
public class registration extends JFrame implements ActionListener {
    ...
    registration(String name) {
        ...
        setTitle("DIGI ATTENDANCE REGISTRATION PAGE");
        setLayout(null);

        JLabel heading1 = new JLabel("Welcome, Kindly Enter The Correct Information ");
        heading1.setBounds(180, 10, 1500, 50);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == sign) {
            ...
            try {
                ...
                Conn conn = new Conn();
                String query = "insert into Registration values('" + Name + "', '" + Registration + "', '" + Email + "', '" + Password + "', '" + degree + "','" + District + "','" + State + "')";
