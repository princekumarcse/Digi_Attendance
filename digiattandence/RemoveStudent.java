...
public class RemoveStudent extends JFrame implements ActionListener {
    ...
    RemoveStudent() {
        ...
        try {
            Conn c = new Conn();
            String query = "select * from StudentDetails where StudentId = '" + cEmpId.getSelectedItem() + "'";
            ResultSet rs = c.s.executeQuery(query);
            while (rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == delete) {
            try {
                Conn c = new Conn();
                String query = "delete from StudentDetails where StudentId = '" + cEmpId.getSelectedItem() + "'";
